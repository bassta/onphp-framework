...
final class IsoCurrency extends Enumeration
{
    ...
    protected $signs = array(self::RUB => 'руб.', self::USD => '$', self::EUR => '€', self::UAH => 'грн.', self::ILS => 'ILS', self::LVL => 'LVL', self::LTL => 'LTL', self::BYR => 'BYR', self::EEK => 'EEK', self::GBP => 'GBP', self::KZT => 'KZT', self::DKK => 'DKK', self::SEK => 'SEK', self::NOK => 'NOK', self::KGS => 'KGS');

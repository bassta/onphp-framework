...
final class MimeType extends Enum
{
    ...
    {
        if (isset(static::$extensions[$this->id])) {
            return static::$extensions[$this->id];
        }
        throw new MissingElementException('Can not find "'.$this->id.'" in extensions map!');
    }

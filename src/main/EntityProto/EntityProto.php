...
class EntityProto extends Singleton
{
    ...
    public final function getFullFormMapping()
    {
    ...
    public final function createObject()
    {
    ...
    public final function getOwnPrimitive($name)
    {
    ...
    public final function getPrimitive($name)
    {
        try {

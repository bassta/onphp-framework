...
class GoogleChart implements Stringable
{
    ...
    {
        $this->fillers->addFiller(GoogleChartSolidFillType::create(GoogleChartSolidFillType::CHART_AREA), $color);
        return $this;
    }

    public function addBackgroundFiller(Color $color)
    {
        $this->fillers->addFiller(GoogleChartSolidFillType::create(GoogleChartSolidFillType::BACKGROUND), $color);
        return $this;
    }

    public function addTransparencyFiller(Color $color)
    {
        $this->fillers->addFiller(GoogleChartSolidFillType::create(GoogleChartSolidFillType::TRANSPARENCY), $color);
        return $this;
    }

...
{
    const DEFAULT_PRECISION = 1.0E-5;
    ...
    public static function makeCartesianProduct($arrays, $generateHash = false)
    {
        $result = array();
    ...
    {
        return self::getCovariance($list1, $list2) / (self::getStandardDeviation($list1) * self::getStandardDeviation($list2));
    }
    ...
    public static function compareFloat($floatOne, $floatTwo, $precision = self::DEFAULT_PRECISION)
    {

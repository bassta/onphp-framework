...
final class AMQPCredentials
{
    ...
    {
        return self::create()->setHost(self::DEFAULT_HOST)->setPort(self::DEFAULT_PORT)->setLogin(self::DEFAULT_LOGIN)
                   ->setPassword(self::DEFAULT_PASSWORD)->setVirtualHost(self::DEFAULT_VHOST);
    }

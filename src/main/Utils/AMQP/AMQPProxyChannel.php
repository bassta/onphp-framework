...
class AMQPProxyChannel implements AMQPChannelInterface
{
    ...
    {
        try {
            return $this->channel->exchangeBind($destinationName, $sourceName, $routingKey);
        } catch (AMQPServerException $e) {
            return $this->transportReconnect($e)->exchangeBind($destinationName, $sourceName, $routingKey);
        }
    }
    ...
    {
        try {
            return $this->channel->exchangeUnbind($destinationName, $sourceName, $routingKey);
        } catch (AMQPServerException $e) {
            return $this->transportReconnect($e)->exchangeUnbind($destinationName, $sourceName, $routingKey);
        }
    }
    ...
    {
        try {
            return $this->channel->queueUnbind($name, $exchange, $routingKey);
        } catch (AMQPServerException $e) {
            return $this->transportReconnect($e)->queueUnbind($name, $exchange, $routingKey);
        }
    }
    ...
    public function queuePurge($name)
    {
        try {
            ...
            return $this->transportReconnect($e)->queuePurge($name);
        }
    }
    ...
    public function basicQos($prefetchSize, $prefetchCount)
    {
        try {
            ...
            return $this->transportReconnect($e)->basicQos($prefetchSize, $prefetchCount);
        }
    }
    ...
    public function basicGet($queue, $autoAck = true)
    {
        try {
            ...
            return $this->transportReconnect($e)->basicGet($queue, $autoAck);
        }
    }
    ...
    public function basicAck($deliveryTag, $multiple = false)
    {
        try {
            ...
            return $this->transportReconnect($e)->basicAck($deliveryTag, $multiple);
        }
    }
    ...
    public function basicConsume($queue, $autoAck, AMQPConsumer $callback)
    {
        try {
            ...
            return $this->transportReconnect($e)->basicConsume($queue, $autoAck, $callback);
        }
    }
    ...
    public function basicCancel($consumerTag)
    {
        try {
            ...
            return $this->transportReconnect($e)->basicCancel($consumerTag);
        }
    }

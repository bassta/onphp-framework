...
final class AMQPPool extends Singleton implements Instantiatable
{
    ...
    public function getLink($name = null)
    {
        ...
        if (!$name) {
            if (!$this->default) {
                throw new MissingElementException('i have no default amqp link and '.'requested link name is null');
            }
            $link = $this->default;
        ...
        throw new MissingElementException("can't find amqp link with '{$name}' name");
    }

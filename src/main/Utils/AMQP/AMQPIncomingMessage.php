...
final class AMQPIncomingMessage extends AMQPBaseMessage
{
    ...
    protected static $mandatoryFields = array(self::ROUTING_KEY, self::DELIVERY_TAG, self::EXCHANGE);
    protected $count = 0;
    ...
    protected function fill(array $assoc)
    {
        ...
        //unset mandatory
        unset($assoc[self::ROUTING_KEY], $assoc[self::DELIVERY_TAG], $assoc[self::EXCHANGE]);

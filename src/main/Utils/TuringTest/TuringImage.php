...
final class TuringImage
{
    ...
    {
        $colorId = imagecolorexact($this->imageId, $color->getRed(), $color->getGreen(), $color->getBlue());
        if ($colorId === -1) {
            $colorId = imagecolorallocate($this->imageId, $color->getRed(), $color->getGreen(), $color->getBlue());
        }
        return $colorId;
    }
    ...
    private function init()
    {
        ...
        $this->getColorIdentifier(new Color('FFFFFF'));
        // white background
        return $this;
    }
    ...
    private function drawBackGround()
    {
        if (!$this->backgroundColors->isEmpty()) {
            ...
            if ($backgroundColor !== null) {
                ...
                imagefilledrectangle($this->imageId, 0, 0, $this->getWidth(), $this->getHeight(), $backgroundColorId);
            }
        }

...
final class MobileUtils extends StaticFactory
{
    ...
    {
        if (MobileRequestDetector::create()->isOperaMini($headers) && isset($headers['HTTP_X_FORWARDED_FOR'])) {
    ...
    {
        if (MobileRequestDetector::create()->isOperaMini($headers) && isset($headers['HTTP_X_OPERAMINI_PHONE_UA'])) {

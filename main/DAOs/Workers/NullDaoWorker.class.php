 ...
 ***************************************************************************/
	...
	**/
	class NullDaoWorker extends CommonDaoWorker
	{
		...
		public function getByLogic(LogicalObject $logic, $expires = Cache::EXPIRES_MEDIUM)
		{
		...
		public function getCustom(SelectQuery $query, $expires = Cache::EXPIRES_MEDIUM)
		{
		...
		public function getListByQuery(SelectQuery $query, $expires = Cache::EXPIRES_MEDIUM)
		{
			return parent::getListByQuery($query, Cache::DO_NOT_CACHE);
		}
		
		public function getListByLogic(LogicalObject $logic, $expires = Cache::EXPIRES_MEDIUM)
		{

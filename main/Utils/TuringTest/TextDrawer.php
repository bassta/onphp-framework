...
abstract class TextDrawer extends Drawer
{
    ...
    public abstract function draw($text);
    ...
    public function drawCraracter($angle, $x, $y, $character)
    {
        ...
        imagettftext($this->getTuringImage()
                          ->getImageId(), $this->size, $angle, $x, $y, $color, $this->getFont(), $character);
        return $this;
    }

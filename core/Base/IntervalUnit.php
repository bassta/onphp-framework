...
final class IntervalUnit
{
    ...
    private static function getUnits()
    {
        static $result = null;
        if (!$result) {
            $result = array('microsecond' => array(0, 0, 1.0E-6), 'millisecond' => array(0, 0, 0.001), 'second' => array(0, 0, 1), 'minute' => array(0, 0, 60), 'hour' => array(0, 0, 3600), 'day' => array(0, 1, 0), 'week' => array(0, 7, 0), 'month' => array(1, 0, 0), 'year' => array(12, 0, 0), 'decade' => array(120, 0, 0), 'century' => array(), 'millennium' => array());
        }
        return $result;
    }

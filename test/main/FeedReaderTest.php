...
final class FeedReaderTest extends TestCase
{
    ...
    {
        $feedChannel = FeedReader::create()->parseFile(dirname(__FILE__).'/data/feedReader/news.xml');
    ...
    {
        $feedChannel = FeedReader::create()->parseFile(dirname(__FILE__).'/data/feedReader/atom_v1_0.xml');
        $feedItems   = $feedChannel->getFeedItems();
        $this->assertTrue($feedChannel instanceof FeedChannel);

...
final class NamespaceResolverTest extends TestCase
{
    ...
    {
        //setup
        $resolver = NamespaceResolverOnPHP::create()->addPath($this->getBasePath().'onPHP');
        //expectation
        $result = array(0 => $this->getBasePath().'onPHP/', '\\MyForm' => 0);
        //execution
    ...
    {
        //setup
        $resolver = NamespaceResolverPSR0::create()->setAllowedUnderline(true)->addPath($this->getBasePath(true));
        //expectation
        $this->assertEquals($this->getBasePath(true).'Under/Class.class.php', $resolver->getClassPath('\\Under_Class'));
        $this->assertEquals($this->getBasePath(true).'Under/Class.class.php', $resolver->getClassPath('\\Under\\Class'));
        $result = array(0 => $this->getBasePath(true), 1 => $this->getBasePath(true).'Under/', '\\Under\\Class' => 1, '\\Under_Class' => 1);
        $this->assertEquals($result, $resolver->getClassPathList());
        //re-setup
    ...
    {
        //setup
        $resolver = NamespaceResolverPSR0::create()->setAllowedUnderline(true)
                                         ->addPath($this->getBasePath(true), 'My\\base_package');
        //expectation
        $this->assertEquals($this->getBasePath(true).'Under/Class.class.php', $resolver->getClassPath('\\My\\base_package\\Under_Class'));
        $this->assertEquals($this->getBasePath(true).'Under/Class.class.php', $resolver->getClassPath('\\My\\base_package\\Under\\Class'));
        $this->assertNull($resolver->getClassPath('\\Under\\Class'));
        $result = array(0 => $this->getBasePath(true), 1 => $this->getBasePath(true).'Under/', '\\My\\base_package\\Under\\Class' => 1, '\\My\\base_package\\Under_Class' => 1);
        $this->assertEquals($result, $resolver->getClassPathList());
        //re-setup
        $resolver->setAllowedUnderline(false);
    ...
    {
        return ONPHP_TEST_PATH.($isUnderline ? 'main/data/namespace_ul/' : 'main/data/namespace/');
    }
}
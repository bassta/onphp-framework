...
final class PrimitiveTimestampTest extends TestCase
{
    public function testMarried()
    {
        ...
        $array = array('test' => array(PrimitiveDate::DAY => '1', PrimitiveDate::MONTH => '2', PrimitiveDate::YEAR => '', PrimitiveTimestamp::HOURS => '17', PrimitiveTimestamp::MINUTES => '38', PrimitiveTimestamp::SECONDS => '59'));
        ...
        $this->assertTrue($prm->import($array));
        $this->assertEquals($prm->getValue()->toDateTime(), '2006-02-01 17:38.59');
        $this->assertFalse($prm->importSingle($array));
    }

    public function testMarriedOptional()
    {
        $prm   = Primitive::timestamp('test')->setComplex()->optional();
        $array = array('test' => array(PrimitiveDate::DAY => '', PrimitiveDate::MONTH => '', PrimitiveDate::YEAR => '', PrimitiveTimestamp::HOURS => '', PrimitiveTimestamp::MINUTES => '', PrimitiveTimestamp::SECONDS => ''));
        $this->assertTrue($prm->import($array));
    }

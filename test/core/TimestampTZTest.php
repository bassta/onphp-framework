...
final class TimestampTZTest extends TestCase
{
    ...
    public function testDifferentZones()
    {
        ...
        $this->assertEquals('2011-01-01 12:10:10+0300', $someDate->toTimestamp('Europe/Moscow')->toString());
        $this->assertEquals($someDate->toTimestamp('Europe/London')->toString(), '2011-01-01 09:10:10+0000');
        ...
        $this->assertEquals(TimestampTZ::compare($moscowTime, $londonTime), -1);
        $this->assertEquals($moscowTime->toTimestamp('Europe/Moscow')->toString(), '2010-12-31 23:59:59+0300');
    }

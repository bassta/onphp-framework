...
final class SequentialCacheTest extends TestCase
{
    public function testMultiCacheAliveLast()
    {
        ...
        //some not existing memcache
        $slave2 = AggregateCache::create()->addPeer('dead', new PeclMemcached('165.34.176.221', '11211'))
                                ->addPeer('dead_too', new PeclMemcached('165.34.176.222', '11211'));
        //some not existing memcache
    ...
    {
        $alifePeer = CyclicAggregateCache::create()->setSummaryWeight(42)
    ...
    {
        $dead1 = new PeclMemcached('35.143.65.241', '11211', 0.01);
        //some not existing memcache
        $dead2 = new PeclMemcached('165.34.176.221', '11211', 0.01);
        //some not existing memcache

...
final class AbstractProtoClassFillQueryTest extends TestCase
{
    ...
    public function testFullUpdateQueryByUser()
    {
        ...
        $this->assertEquals('UPDATE  SET id = 77, nickname = NULL, password = NULL, '.'very_custom_field_name = 2011-12-31 00:00:00, '.'registered = 2011-12-30 00:00:00, strange_time = 01:23:45, '.'city_id = 20, first_optional_id = NULL, second_optional_id = NULL, '.'url = https://www.github.com, '.'properties = "a"=>"apple","b"=>"bananas",, ip = 127.0.0.1', $updateUser->toDialectString(ImaginaryDialect::me()));
    }
    ...
    public function testFullUpdateQueryByUserWithContactExt()
    {
        ...
        $updateUser   = $user->proto()->fillQuery(OSQL::update(), $user);
        $this->assertEquals('UPDATE  SET id = 77, name = Aleksey, surname = Alekseev, email = foo@bar.com, '.'icq = 12345678, phone = 89012345678, city_id = NULL, '.'web = https://www.github.com/, skype = github', $updateUser->toDialectString(ImaginaryDialect::me()));
    }

    public function testUpdateQueryByCityOneBoolean()
    {
        $cityOld = $this->spawnCity(array('capital' => false));
        $city    = $this->spawnCity(array('capital' => true));
        //1918
        $updateCity = $city->proto()->fillQuery(OSQL::update(), $city, $cityOld);
        $this->assertEquals('UPDATE  SET capital = TRUE', $updateCity->toDialectString(ImaginaryDialect::me()));
    }
    ...
    public function testUpdateQueryByCityOneString()
    {
        ...
        $updateCity = $city->proto()->fillQuery(OSQL::update(), $city, $cityOld);
        $this->assertEquals('UPDATE  SET name = Saint-Peterburg', $updateCity->toDialectString(ImaginaryDialect::me()));
    }

    public function testUpdateQueryByUserTimesAndUrl()
    {
        $oldUser    = $this->spawnUser(array('strangeTime' => Time::create('12:12:12'), 'url' => HttpUrl::create()
                                                                                                        ->parse('http://code.google.com/')));
        $user       = $this->spawnUser(array('lastLogin' => Timestamp::create('2012-01-01')));
        $updateUser = $user->proto()->fillQuery(OSQL::update(), $user, $oldUser);
        $this->assertEquals('UPDATE  SET very_custom_field_name = 2012-01-01 00:00:00, '.'strange_time = 01:23:45, url = https://www.github.com', $updateUser->toDialectString(ImaginaryDialect::me()));
    }
    ...
    public function testUpdateQueryByUserCitiesAndHstore()
    {
        ...
        $userParams = array('city' => $moscow, 'firstOptional' => $piter, 'secondOptional' => null, 'properties' => Hstore::make(array()));
        $oldUser    = $this->spawnUser($userParams);
        $userParams = array('city' => $piter, 'firstOptional' => null, 'secondOptional' => $omsk, 'properties' => Hstore::make(array('param' => 'value')));
        $user       = $this->spawnUser($userParams);
        $updateUser = $user->proto()->fillQuery(OSQL::update(), $user, $oldUser);
        $this->assertEquals('UPDATE  SET city_id = 2, first_optional_id = NULL, '.'second_optional_id = 3, properties = "param"=>"value",', $updateUser->toDialectString(ImaginaryDialect::me()));
    }
    ...
    public function testUpdateQueryByUserWithValueObject()
    {
        ...
        $updateUser    = $user->proto()->fillQuery(OSQL::update(), $user, $oldUser);
        $this->assertEquals('UPDATE  SET email = foo@bar.com, city_id = 20', $updateUser->toDialectString(ImaginaryDialect::me()));
    }
    ...
    {
        $options += array('id' => '77', 'credentials' => Credentials::create(), 'lastLogin' => Timestamp::create('2011-12-31'), 'registered' => Timestamp::create('2011-12-30'), 'strangeTime' => Time::create('01:23:45'), 'city' => null, 'firstOptional' => null, 'secondOptional' => null, 'url' => HttpUrl::create()
                                                                                                                                                                                                                                                                                                               ->parse('https://www.github.com'), 'properties' => Hstore::make(array('a' => 'apple', 'b' => 'bananas')), 'ip' => IpAddress::create('127.0.0.1'));
    ...
    {
        $options += array('web' => 'https://www.github.com/', 'skype' => 'github', 'email' => 'foo@bar.com', 'icq' => 12345678, 'phone' => '89012345678', 'city' => null);
    ...
    {
        $options += array('id' => '77', 'name' => 'Aleksey', 'surname' => 'Alekseev', 'contactExt' => null);

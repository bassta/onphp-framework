...
final class DateTest extends TestCase
{
    ...
    public function testClone()
    {
        ...
        $date2 = clone $date1;
        $this->assertFalse($date1->getDateTime() === $date2->getDateTime());
    }
    ...
    public function testWeekCount()
    {
        ...
        $this->assertEquals(Date::makeFromWeek(1, 2010)->toStamp(), Date::create('2010-01-04')
                                                                        ->toStamp(), 'Week 1 for 2010 starts with incorrect date.');
    ...
    private function makeFromWeekTest(Date $date)
    {
        ...
        $this->assertEquals(Date::makeFromWeek(date('W', $date->toStamp()), date('Y', $date->toStamp())), $date);
        return $this;
    }
}
...
final class PrimitiveAliasTest extends TestCase
{
    public function testImport()
    {
        ...
        $form          = Form::create()->add($realPrimitive)->add(Primitive::alias('alias', $realPrimitive))
        ...
        $form          = Form::create()->add($enumPrimitive)->add(Primitive::alias('alias', $enumPrimitive))
